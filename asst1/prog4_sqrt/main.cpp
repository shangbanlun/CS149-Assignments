...
int main() {
    ...
    const unsigned int numTask = 4;
    double minTaskISPC = 1e30;
    for (int i = 0; i < 3; ++i) {
        double startTime = CycleTimer::currentSeconds();
        sqrt_ispc_withtasks(N, initialGuess, values, numTask, output);
        double endTime = CycleTimer::currentSeconds();
    ...
    printf("\t\t\t\t(%.2fx speedup from task[1] ISPC to task[%d] ISPC)\n", minISPC/minTaskISPC, numTask);
